        ...
        <div className="max-w-4xl mx-auto mb-12">
          ...
          <div className="flex flex-wrap gap-6 text-muted-foreground mb-8">
            <div className="flex items-center gap-2">
              ...
              <span>Platform Leaders, HR Partners</span>
            </div>
            <div className="flex items-center gap-2">
              <Clock className="w-4 h-4" />
              <span>Team building guide</span>
            </div>
          </div>
          ...
          <Card className="mb-12 text-center">
            <CardHeader>
              ...
              <CardDescription className="text-lg">
                We're creating content about finding sponsors and building core teams. 
                This will include stakeholder mapping, team formation strategies, and engagement frameworks.
              </CardDescription>
            </CardHeader>
          </Card>
...
export default FindSponsorsCoreTeam;