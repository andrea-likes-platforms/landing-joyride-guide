...
const PEEnablementServicesCanvas = () => {
  return (
    <Layout>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          ...
          <div className="flex flex-wrap gap-6 text-muted-foreground mb-8">
            <div className="flex items-center gap-2">
              ...
              <span>Platform Engineers, Service Designers</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <Card className="mb-12 text-center">
            <CardHeader>
              ...
              <CardDescription className="text-lg">
                We're developing content about the PE Enablement Services Canvas. 
                This will include service design patterns, templates, and examples.
              </CardDescription>
            </CardHeader>
          </Card>
...
export default PEEnablementServicesCanvas;